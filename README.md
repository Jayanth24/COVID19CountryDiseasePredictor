...
In terms of the countries column, similar to the modifications made in the date column, we instated a mapping for the countries from 1 to 167 for what each country numerically represents. This was done in alphabetical order starting with Afghanistan.  
